...
function populateCheckout() {
  if (getFromStorage("trial", false)) {
    ...
    container.innerHTML = `
     <div class="result_btn_contain u-mt-4 u-mb-2"><div data-button-style="primary" class="btn_main_wrap"><div class="g_clickable_wrap"><a  target="" href="#" class="g_clickable_link w-inline-block"><span class="g_clickable_text u-sr-only">Kurseinheit ausprobieren</span></a><button type="button" id="button_trial_submit" data-btn-next="" class="g_clickable_btn"><span class="g_clickable_text u-sr-only">Kurseinheit ausprobieren</span></button></div><div aria-hidden="true" class="btn_main_text">Kurseinheit ausprobieren</div></div></div>
    `;
